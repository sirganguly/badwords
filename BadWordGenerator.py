...
bad_words_hindi = [bad_words_hindi1,bad_words_hindi2,bad_words_hindi3]
random_words_hindi = [random.choice(i) for i in bad_words_hindi]
...
bad_words_english = [bad_words_english1,bad_words_english2]
random_words_english = [random.choice(i) for i in bad_words_english]
